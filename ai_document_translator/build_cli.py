...
def main():
    ...
    parser.add_argument("action", choices=["prepare"], help="操作类型: prepare(准备)")
    ...
    try:
        ...
        if args.action == "prepare":
            ...
            processed_files = build_manager.prepare_build_environment()
            print(f"准备完成，共处理 {len(processed_files)} 个文件")
